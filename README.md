...
And as technology advances, the people using it should be able to advance with it.
...
**Dream it → Build it → Ship it → Own it.**
...
[Read the documentation](https://synomize.io/docs) · [Download the welcome PDF](docs/Synomize-Welcome.pdf)

Synomize is not open source at this time. See [LICENSE](LICENSE).
